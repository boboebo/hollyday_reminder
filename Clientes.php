  ...
  <tr>
    <td width="1029"> 
      <table width="1010" border="0" cellspacing="0" cellpadding="0" align="center">
		...
		$ssql2 = " SELECT * FROM clientes WHERE IdUsuario=$id_usuario"; 
		
		if($buscado<>'')
		  $ssql2.= " AND ClienteNombre LIKE '%$buscado%'  "; 
                    ...
                    <tr>
                      <td align="center" height="220" valign="top"> 
                        <table width="865" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="148">&nbsp;</td>
                            <td width="611" align="center" valign="top"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#333333"><b><font size="4">Clientes</font><font size="4"><br>
                              <?
			if($_REQUEST['resultado']<>"")
			{
				if($_REQUEST['resultado']==1){$mensaje= "¡¡ Los Datos del Cliente se Registraron Correctamente !!"; $colormensaje="#339900";};
				if($_REQUEST['resultado']==12){$mensaje="¡¡ Ya Existe un Cliente con igual Nombre !!"; $colormensaje="#CC0000";};
				if($_REQUEST['resultado']==13){$mensaje="¡¡ Ya Existe un Cliente con igual E-Mail !!"; $colormensaje="#CC0000";};
				if($_REQUEST['resultado']==2){$mensaje= "¡¡ Los Datos del Cliente se Cambiaron Correctamente !!"; $colormensaje="#339900";};
				if($_REQUEST['resultado']==3){$mensaje= "¡¡ El Cliente fue BORRADO con Exito !!"; $colormensaje="#339900";};
			...
			?>
                                      ...
                                      <table width="600" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
                                        <tr> 
                                          <td height="25" bgcolor="#F4F4F4" width="30%"> 
                                            <div align="center"><font face="Arial, Helvetica, sans-serif" size="2" color="#666666">Clientes 
                                          con Nombre :</font></div>                                          </td>
                                          <td height="25" bgcolor="#F4F4F4" colspan="3"> 
                                            <input class=campos3 type="text" name="buscado" value="<? echo $buscado;?>" size="40">
                                            <input  type="hidden" name="Usuario" value="<?echo $id_usuario?>">                                          </td>
                        ...
                        <table width="800" border="0" align="center" height="20" cellpadding="0" cellspacing="0">
                          <tr bgcolor="#FFFFFF"> 
                            <td width="211" height="24" align="left" valign="bottom" bgcolor="#D6DBCC"> 
                              <a href="Nuevo_Cliente.php?opcion=1" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image999','','images/Botones/bot_NuevoUsuario2.jpg',1)" > 
                              <img src="images/bot_Nuevo1.png" name="image999"  width="124" height="24" border="0" title="Nuevo Usuario" align="middle"></a></td>
                        ...
                        <table width="800" border="0" align="center" bgcolor="#E6E6E6" dwcopytype="CopyTableRow">
                          <tr> 
                            ...
                            <td width="372" height="27" background="images/topgrilla.gif"> 
                            ...
                            <td width="282" align="center" background="images/topgrilla.gif"><font face="Arial, Helvetica, sans-serif" size="2" color="#666666"><b>Email</b></font></td>
...
{   
	...
	?>
                          <tr onMouseOver="mo_in(this,'#BBC9D9')" onMouseOut="mo_out(this,'<? echo $color;?>')" bgcolor="<? echo $color;?>"> 
                            ...
                            <td align="center"> 
                              <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#333333"><? echo $row["ClienteMail"]; ?></font></div>                              </td>
                            <td width="35" align="center"> 
                              <a  title="Eliminar Usuario" href="ABM_Clientes.php?opcion=3&idcli=<? echo $row["IdCliente"];?>" onClick="return confirm('¿ Esta seguro que desea borrar el Cliente <? echo $row["ClienteNombre"];?> ? ')"><img src="images/borrar.png" width="16" height="16" border="0" title="Borrar Usuario"></a>                            </td>
                            <td colspan="2" width="43"> 
                              <div align="center"><a  title="Cambiar Datos del Usuario" class="Menu1" href="Nuevo_Cliente.php?idcli=<? echo $row["IdCliente"];?>&opcion=2" style="TEXT-DECORATION: none"><img src="images/cambiar.png" width="16" height="16" border="0" title="Cambiar Datos"></a></div> </td>
						  </tr>
                          <?
	}
}
