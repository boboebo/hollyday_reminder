...
function submitForms()
 {if (  is_nombre() && is_usuario() && is_clave() && is_clave2() && is_email() )
	return true;
	else 
	return false;
}
...
alert ("\n ¡¡ Debe Cargar el E-Mail del Usuario para ingresar al Sistema !!.")
                        ...
                        <table width="905" border="0" cellspacing="0" cellpadding="0" bgcolor="#D6DBCC" height="303" align="center">
                          <tr bgcolor="#D6DBCC"> 
                            <td height="303"  valign="top"> 
							 ...
							 <? 
							 $idusu = $_SESSION['IdUsuarioSes'];
							
							 $ssql= "select * from usuarios where IdUsuario=$idusu ";
   							 $result = mysql_db_query($BaseDatos,$ssql);
							
				             $num_total_registros = @mysql_num_rows($result);
							 
					         if ($num_total_registros == 0) $opcion=1;
						     else $opcion=2;
			                 
							$row=@mysql_fetch_array($result);
					    
								 $nombre=$row['UsuarioNombre'];
								 $pass=$row['UsuarioPass'];
								 $nick=$row['UsuarioNick'];
								 $mail=$row['UsuarioMail'];
								 $Provincia=$row['UsuarioProvincia'];
								 $Pais=$row['UsuarioPais'];
							?>
							 <form name="form1" method="post" action="ABM_Usuarios.php?opcion=<? echo $opcion;?>" autocomplete="off" onSubmit="return submitForms()">
							   <table width="451" border="0" height="251" cellpadding="1" cellspacing="1" align="center" bgcolor="#E1E1E1">
                                  <tr> 
                                    <td width="463" height="249" align="center" valign="top"> 
                                      <table width="450" border="0" cellpadding="1" cellspacing="1" height="243" bgcolor="#F3F3F3">
                                        <tr> 
                                          <td height="40" colspan="2" bgcolor="#D6DBCC"> 
                                            <div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#333333"><b><font size="4">Usuario</font></b></font></div></td>
                                        </tr>
                                        <tr> 
                                          <td width="127" height="31" bgcolor="#C4D9BD"> 
                                          ...
                                          <td width="316" height="31" colspan="-1" bgcolor="#C4D9BD"> 
                                            <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                                            <input type="text" value="<? echo $nombre;?>" name="nombre" size="30" maxlength="40" onKeyUp="form1.nombre.value=form1.nombre.value.toUpperCase();">
                                          <font size="1" color="#FF0000"><b>(*)</b></font></font></td>
                                        </tr>
                                        <tr> 
                                          <td width="127" height="30" bgcolor="#E8EFE4"> 
                                          <div align="right"><strong><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#666666">Usuario:</font></strong></div>                                          </td>
                                          <td width="316" height="30" colspan="-1" bgcolor="#E8EFE4"> 
                                            ...
                                            <input type="text" value="<? echo $nick;?>" name="usuario" size="10" maxlength="10">
                                          <font size="1" color="#FF0000"><b>(*)</b></font></font>                                          </td>
                                        </tr>
                                        <tr bgcolor="#C4D9BD"> 
                                          ...
                                          <td width="316" height="30" colspan="-1"> 
                                            <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                                            <input type="password" value="<? echo $pass;?>" name="clave" size="20" maxlength="20">
                                          <font size="1" color="#FF0000"><b>(*)</b></font></font></td>
                                        </tr>
                                        <tr> 
                                          ...
                                          <td width="316" height="32" colspan="-1" bgcolor="#E8EFE4"> 
                                            <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                                            <input type="password" value="<? echo $pass;?>" name="clave2" size="20" maxlength="20">
                                          <font size="1" color="#FF0000"><b>(*)</b></font></font></td>
                                        </tr>
                                        ...
                                        <tr bgcolor="#C4D9BD"> 
                                          ...
                                          <td width="316" height="31" colspan="-1"> 
                                            <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
										...
										<tr bgcolor="#C4D9BD"> 
                                          <td width="127" height="31" bgcolor="#E8EFE4"> 
                                          <div align="right"><strong><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#666666">Provincia:</font></strong></div>                                          </td>
                                          <td width="316" height="31" colspan="-1" bgcolor="#E8EFE4"> 
                                            <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                                            <input name="Provincia" type="text" id="Provincia" value="<? echo $Provincia;?>" size="30" maxlength="40">
                                          </font></td>
                                        </tr>
										
										<tr bgcolor="#C4D9BD"> 
                                          <td width="127" height="31" bgcolor="#C4D9BD"> 
                                          <div align="right"><strong><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#666666">Pais:</font></strong></div>                                          </td>
                                          <td width="316" height="31" colspan="-1"> 
                                            <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                                            <input name="Pais" type="text" id="Pais" value="<? echo $Pais;?>" size="30" maxlength="40">
                                            </font></td>
                                        </tr>
                                ...
                                <div align="center">
                                  <p><a href="<? echo $link;?>"><img src="images/BotonVolver.jpg" height="30" border="0"></a>                                  </p>
                                </div>
                            </form>                            </td>
                          </tr>
